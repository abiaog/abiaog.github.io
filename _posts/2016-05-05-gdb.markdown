...
you can connect using "target extended-remote" and start the program you want to debug.  The syntax is:
...
On host,
	...
	(gdb) r
	Starting program: /home/peter/work/src/abiaog.github.io/code_for_post/gdb/power 
